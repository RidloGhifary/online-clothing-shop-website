    ...
    <section className="w-full max-w-[900px] mx-auto p-4" id="information">
      <div className="grid grid-cols-1 gap-9 max-w-[650px] mx-auto">
        <div className="grid grid-cols-2 items-center justify-center">
          ...
          <div className="">
            <h1 className="text-neutral-900 text-3xl md:text-5xl font-semibold">Free ongkir se-Jawa</h1>
        ...
        <div className="grid grid-cols-2 items-center">
          <div className="text-right">
            <h1 className="text-neutral-900 text-3xl md:text-5xl font-semibold">Double stack Jahitan</h1>
        ...
        <div className="grid grid-cols-2 items-center justify-center">
          <Image src={poster3} alt="posterInformation" width={300} height={300}
            className="rounded-md shadow-md w-[200px] h-[200px] mx-auto object-cover object-center" />
          <div className="">
            <h1 className="text-neutral-900 text-3xl md:text-5xl font-semibold">Jahitan Rantai</h1>
